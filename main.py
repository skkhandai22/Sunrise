...
def main():
    ...
    if file_option=="data.csv":
        ...
        if selection=="Vizualization":
            st.markdown('<iframe title="powerbi-data-report-12" width="800" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiZDM1ZGFjZGQtNjZkZS00MWMxLTk4M2EtMTFiYTlkNDdjZjg2IiwidCI6ImE2MTdlYzYwLTBhYjMtNDBiZS05MjhmLWJmMzY1MzA4NDkxYSIsImMiOjF9" frameborder="0" allowFullScreen="true"></iframe>',unsafe_allow_html=True)
